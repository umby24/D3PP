...
int LuaEntityLib::LuaEntityAdd(lua_State* L) {
    ...
    if (nArgs != 7) {
        Logger::LogAdd("Lua", "LuaError: Entity.Add called with invalid number of arguments.", WARNING, GLF);
        return 0;
    }
...
int LuaEntityLib::LuaEntityDelete(lua_State* L) {
    ...
    if (nArgs != 1) {
        Logger::LogAdd("Lua", "LuaError: Entity_Delete called with invalid number of arguments.", WARNING, GLF);
        return 0;
    }
...
int LuaEntityLib::LuaEntityGetPlayer(lua_State* L) {
    ...
    if (nArgs != 1) {
        Logger::LogAdd("Lua", "LuaError: ENTITY_GET_PLAYER called with invalid number of arguments.", WARNING, GLF);
        return 0;
    }
    int entityId = static_cast<int>(luaL_checkinteger(L, 1));
    int result = -1;
...
int LuaEntityLib::LuaEntityGetMapId(lua_State* L) {
    ...
    if (nArgs != 1) {
        Logger::LogAdd("Lua", "LuaError: ENTITY_GET_Map_Id called with invalid number of arguments.", WARNING, GLF);
        return 0;
    }
...
int LuaEntityLib::LuaEntityGetPosition(lua_State* L) {
    ...
    if (nArgs != 1) {
        Logger::LogAdd("Lua", "LuaError: Entity.GetPosition called with invalid number of arguments.", WARNING, GLF);
        return 0;
    }
    int entityId = luaL_checkinteger(L, 1);
    float resultX = -1;
...
int LuaEntityLib::LuaEntityGetRotation(lua_State* L) {
    ...
    if (nArgs != 1) {
        Logger::LogAdd("Lua", "LuaError: ENTITY_GET_Rotation called with invalid number of arguments.", WARNING, GLF);
        return 0;
    }
    int entityId = luaL_checkinteger(L, 1);
    float result = -1;
...
int LuaEntityLib::LuaEntityGetLook(lua_State* L) {
    ...
    if (nArgs != 1) {
        Logger::LogAdd("Lua", "LuaError: ENTITY_GET_Look called with invalid number of arguments.", WARNING, GLF);
        return 0;
    }
...
int LuaEntityLib::LuaEntityResend(lua_State* L) {
    ...
    if (nArgs != 1) {
        Logger::LogAdd("Lua", "LuaError: Entity_Resend called with invalid number of arguments.", WARNING, GLF);
        return 0;
    }
    int entityId = luaL_checkinteger(L, 1);
    std::shared_ptr<Entity> foundEntity = Entity::GetPointer(entityId);
...
int LuaEntityLib::LuaEntityMessage2Clients(lua_State* L) {
    ...
    if (nArgs != 2) {
        Logger::LogAdd("Lua", "LuaError: Entity_Message_2_Clients called with invalid number of arguments.", WARNING, GLF);
        return 0;
    }
    int entityid = luaL_checkinteger(L, 1);
...
int LuaEntityLib::LuaEntityDisplaynameGet(lua_State* L) {
    ...
    if (nArgs != 1) {
        Logger::LogAdd("Lua", "LuaError: ENTITY_displayname_get called with invalid number of arguments.", WARNING, GLF);
        return 0;
    }
    int entityId = luaL_checkinteger(L, 1);
    std::shared_ptr<Entity> foundEntity = Entity::GetPointer(entityId);
...
int LuaEntityLib::LuaEntityDisplaynameSet(lua_State* L) {
    ...
    if (nArgs != 4 && nArgs != 2) {
        Logger::LogAdd("Lua", "LuaError: ENTITY_displayname_set called with invalid number of arguments.", WARNING, GLF);
        return 0;
    }
...
int LuaEntityLib::LuaEntityPositionSet(lua_State* L) {
    ...
    if (nArgs != 7) {
        Logger::LogAdd("Lua", "LuaError: ENTITY_Position_Set called with invalid number of arguments.", WARNING, GLF);
        return 0;
    }
    int entityId = luaL_checkinteger(L, 1);
...
int LuaEntityLib::LuaEntityKill(lua_State* L) {
    ...
    if (nArgs != 1) {
        Logger::LogAdd("Lua", "LuaError: ENTITY_Kill called with invalid number of arguments.", WARNING, GLF);
        return 0;
    }
    int entityId = luaL_checkinteger(L, 1);
    std::shared_ptr<Entity> foundEntity = Entity::GetPointer(entityId);
...
int LuaEntityLib::LuaEntitySetModel(lua_State *L) {
    ...
    if (nArgs != 2) {
        Logger::LogAdd("Lua", "LuaError: Entity.SetModel called with invalid number of arguments.", WARNING, GLF);
        return 0;
    }
    int entityId = static_cast<int>(luaL_checkinteger(L, 1));
